    ...
    <aside style={{ width: 220, background: "#0a0e1a", borderRight: "1px solid #1a2236", display: "flex", flexDirection: "column", padding: "24px 0", position: "fixed", height: "100vh", zIndex: 10 }}>
      <div style={{ padding: "0 20px 24px", borderBottom: "1px solid #1a2236" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <div style={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg,#60a5fa,#8b5cf6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 16, flexShrink: 0, color: "#fff", fontWeight: 600 }}>E</div>
          <div>
            <div style={{ color: "#e2eaf8", fontSize: 13, fontWeight: 700 }}>Erica Santos</div>
